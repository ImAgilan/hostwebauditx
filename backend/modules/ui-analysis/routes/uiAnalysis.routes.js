...
const controller = require('../controller/uiAnalysis.controller');
...
router.get('/reports',      optionalAuth, controller.getRecentReports);
router.get('/report/:id',   optionalAuth, controller.getReport);
router.get('/download/:id', requireAuth,  controller.downloadPDF);
