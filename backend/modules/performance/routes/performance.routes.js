...
const ctrl    = require('../controller/performance.controller');
...
router.post('/ai-report/:id', optionalAuth, ctrl.generateAI);
router.get('/download/:id',   requireAuth,  ctrl.downloadPDF);
router.get('/history',        optionalAuth, ctrl.getHistory);
