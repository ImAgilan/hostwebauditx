...
const ctrl    = require('../controller/technicalInsight.controller');
...
router.get ('/list',           optionalAuth, ctrl.listReports);
router.get ('/report/:id',     optionalAuth, ctrl.getReport);
router.post('/ai-report/:id',  optionalAuth, ctrl.generateAIReport);
